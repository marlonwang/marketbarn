...
public final class AESUtils
{
	...
	// AES默认加密key
	private static final String AES_DEFAULT_KEY = "APP.MAKER";
			...
			throws Exception
	{
		...
		{
			throw new Exception("Failed to encrypt for content: "
	...
	public static String decrypt(String content, String decryptKey) throws Exception
	{
		...
		{
			throw new Exception("Failed to decrypt for content: "
	...
	public static String decryptCbc(String content, String decryptKey) throws Exception
	{
		if (StringUtils.isEmpty(content) || StringUtils.isEmpty(decryptKey))
		{
			return null;
	...
	public static String encryptNoPadding(String content, String encryptKey) throws Exception
	{
		if (StringUtils.isEmpty(content) || StringUtils.isEmpty(encryptKey))
		{
			return null;
	...
	public static String decryptNoPadding(String content, String decryptKey) throws Exception
	{
		if (StringUtils.isEmpty(content) || StringUtils.isEmpty(decryptKey))
		{
			return null;
